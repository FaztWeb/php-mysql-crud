  ...
  <form  action="search.php" method="get" class="searchForm">
    ...
    <div class="table">
      <table class="table table-hover table-#dbd7d2"> 
        ...
        $sql_registe = mysqli_query($conn, "SELECT COUNT(*) AS all_registers FROM basicos 
        WHERE(Nombres  LIKE '%$search%' OR 
              Apellidos LIKE '%$search%'OR  
              Empresa LIKE '%$search%'OR 
              TelefonoEmpresaDirecto LIKE '%$search%'OR 
              CelularEmpresa LIKE '%$search%')
          AND statusNumber = 1");
...
WHERE
(
  b.Nombres  LIKE '%$search%' OR
  b.Apellidos LIKE '%$search%' OR
  b.Empresa LIKE '%$search%'OR
  b.TelefonoEmpresaDirecto LIKE '%$search%'OR
  b.CelularEmpresa LIKE '%$search%'
)
AND
 statusNumber = 1
