...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?>
      <div>
        <h1 style="width: 14rem;">Rango Edad</h1>
      </div>
      ...
      <table class="table table-bordered">
        ...
        //    
          ...
          <tr>
            ...
            <td>
              <!-- REDIRECCION EDITAR -->
              <a href="../edit/editRangeAge.php?IdRangoEdad=<?php echo $row['IdRangoEdad']?>" class="btn btn-secondary">
              <!-- ICONO EDITAR -->
                <i class="fas fa-marker"></i>
              </a>
              <!-- REDIRECCION ELIMINAR -->
              <a href="../delete/delete_taskRangeAge.php?IdRangoEdad=<?php echo $row['IdRangoEdad']?>" class="btn btn-danger">
              <!-- ICONO ELIMINAR -->
