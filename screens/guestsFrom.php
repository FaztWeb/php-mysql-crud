...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?>
      <div>
        <h1 style="width: 14rem;">Invitados Por</h1>
      </div>
      <!-- FORMURLARIO DEFINE METODO DE PETICION Y RUTA DE LOS DATOS -->
      <div class="card card-body">
        <form action="../save_tasks/save_taskGuestFrom.php" method="POST">
          <div class="form-group">
            <input type="text" name="InvitadoPor" class="form-control" placeholder="Invitado Por" autofocus>
          </div>
          <div class="form-group">
    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        //    
          ...
          <!-- DATOS A ITERAR -->
          <tr>
            <td><?php echo $row['InvitadoPor']; ?></td>
