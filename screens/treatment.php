...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?>
      <div>
        <h1 style="width: 14rem;">Tratamiento</h1>
      </div>
      <!-- FORMURLARIO DEFINE METODO DE PETICION Y RUTA DE LOS DATOS -->
      <div class="card card-body">
        <form action="../save_tasks/save_taskTreatment.php" method="POST">
          <div class="form-group">
            <input type="text" name="Tratamiento" class="form-control" placeholder="Tratamiento" autofocus>
          </div>
          <div class="form-group">
      ...
      <table class="table table-bordered">
        ...
        //    
          ...
          <tr>
            ...
            <td>
              <!-- REDIRECCION EDITAR -->
              <a href="../edit/editTreatment.php?IdTratamiento=<?php echo $row['IdTratamiento']?>" class="btn btn-secondary">
              <!-- ICONO EDITAR -->
                <i class="fas fa-marker"></i>
              </a>
              <!-- REDIRECCION ELIMINAR -->
              <a href="../delete/delete_taskTreatment.php?IdTratamiento=<?php echo $row['IdTratamiento']?>" class="btn btn-danger">
              <!-- ICONO ELIMINAR -->
