...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?>
      <div>
        <h1 style="width: 14rem;">Interes</h1>
      </div>
      <!-- FORMURLARIO DEFINE METODO DE PETICION Y RUTA DE LOS DATOS -->
      <div class="card card-body">
        <form action="../save_tasks/save_taskInterests.php" method="POST">
          <div class="form-group">
            <input type="text" name="Interes" class="form-control" placeholder="Interes" autofocus>
          </div>
          <div class="form-group">
      ...
      <table class="table table-bordered">
        ...
        //    
          ...
          <tr>
            ...
            <td>
              <!-- REDIRECCION EDITAR -->
              <a href="../edit/editInterests.php?IdInteres=<?php echo $row['IdInteres']?>" class="btn btn-secondary">
              <!-- ICONO EDITAR -->
                <i class="fas fa-marker"></i>
              </a>
              <!-- REDIRECCION ELIMINAR -->
              <a href="../delete/delete_taskInterests.php?IdInteres=<?php echo $row['IdInteres']?>" class="btn btn-danger">
              <!-- ICONO ELIMINAR -->
