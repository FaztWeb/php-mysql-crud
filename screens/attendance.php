      ...
      <div class="card card-body">
        <form action="../save_tasks/save_taskAttendance.php" method="POST">
          <div class="form-group">
            <input type="text" name="Asistencia" class="form-control" placeholder="Asistencia" required autofocus>
          </div>
          <div class="form-group">
        ...
        //    
          ...
          <tr>
            ...
            <td>
              ...
              <a href="../delete/delete_taskAttendance.php?IdAsistencia=<?php echo $row['IdAsistencia']?>" 
