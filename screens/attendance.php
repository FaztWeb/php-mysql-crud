...
<main class="container p-4">
  <div class="row">
    <div class="col-md-4">
      ...
      <?php session_unset(); } ?>
      <div>
        <h1 style="width: 14rem;">Asistencia</h1>
      </div>
      <!-- FORMURLARIO DEFINE METODO DE PETICION Y RUTA DE LOS DATOS -->
      <div class="card card-body">
        <form action="../save_tasks/save_taskAttendance.php" method="POST">
          <div class="form-group">
            <input type="text" name="Asistencia" class="form-control" placeholder="Asistencia" autofocus>
          </div>
          <div class="form-group">
      ...
      <table class="table table-bordered">
        ...
        //    
          ...
          <tr>
            ...
            <td>
              <!-- REDIRECCION EDITAR -->
              <a href="../edit/editAttendance.php?IdAsistencia=<?php echo $row['IdAsistencia']?>" class="btn btn-secondary">
              <!-- ICONO EDITAR -->
                <i class="fas fa-marker"></i>
              </a>
              <!-- REDIRECCION ELIMINAR -->
              <a href="../delete/delete_taskAttendance.php?IdAsistencia=<?php echo $row['IdAsistencia']?>" class="btn btn-danger">
              <!-- ICONO ELIMINAR -->
